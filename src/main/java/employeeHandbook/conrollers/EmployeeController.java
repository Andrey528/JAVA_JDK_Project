package employeeHandbook.conrollers;

import employeeHandbook.models.Employee;
import employeeHandbook.models.EmployeeRepo;
import employeeHandbook.presenters.ConsoleView;

import java.util.ArrayList;
import java.util.List;

public class EmployeeController {
    private EmployeeRepo currentBook = new EmployeeRepo();
    ...
    public void findEmployeeByExperience() {
        ...
        for (int i = 0; i < currentBook.employeesLen(); i++) {
